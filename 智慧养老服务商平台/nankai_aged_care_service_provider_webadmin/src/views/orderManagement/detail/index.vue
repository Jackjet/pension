<template>
    <el-main>
        <div :class="['main-section']">
            ...
            <el-row :gutter="20">
                <el-col :offset="3" :span="6" v-if="detailType==='1' || detailType==='2' || detailType==='3' || detailType==='22'">
                    <span>接单日期：</span>
                    <span>{{info.acceptTime}}</span>
                </el-col>
                <el-col :span="8" v-if="detailType==='1' || detailType==='2' || detailType==='3'">
                    <span>分配人员时间：</span>
            ...
            <el-row :gutter="20">
                <el-col :offset="3" :span="6"  v-if="detailType==='2' || detailType==='3'">
                    <span>确认上门方式：</span>
                    <span>{{info.startWay_show}}</span>
                </el-col>

                <el-col :span="8" v-if="detailType==='2' || detailType==='3'">
                    <span>开始服务时间：</span>
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="6" v-if="detailType==='3'">
                    <span>是否已评价：</span>
                    <span>{{info.isAppraise_show}}</span>
                </el-col>
                <el-col :span="8" v-if="detailType==='3'">
                    <span>结束服务时间：</span>
            ...
            <el-row :gutter="20"  v-if="detailType==='2' || detailType==='3'">
                <el-col :offset="3" :span="3">
                    <span>服务照片：</span>
                </el-col>
            </el-row>
            <el-row  v-if="detailType==='2' || detailType==='3'">
            ...
            <el-row :gutter="20">
                ...
                <el-col :span="12" v-if="detailType==='2' || detailType==='3'">
                    <span>服务时间异常原因：</span>
            ...
            <el-row :gutter="20">
                <el-col :offset="3" :span="6" v-if="detailType==='1' || detailType==='2' || detailType==='3'">
                    <span>服务人员名称：</span>
  ...
  methods: {
    async initial () {
      ...
      try {
        ...
        that.info.startWay_show = that.getLabelByValue(that.info.startWay, options.startWay)
        that.info.isAppraise_show = that.getLabelByValue(that.info.isAppraise, options.yesOrNo)
        that.info.abnormal2_show = that.getLabelByValue(that.info.abnormal2, options.yesOrNo)
        that.info.abnormal1_show = that.getLabelByValue(that.info.abnormal1, options.yesOrNo)
        that.info.serviceAddress = that.info.areaName + that.info.streetName + that.info.communityName + that.info.address

        that.info.img1_show = that.api.resource.lib + response.data.img1
        that.info.img2_show = that.api.resource.lib + response.data.img2
        that.info.img3_show = that.api.resource.lib + response.data.img3
        that.info.img4_show = that.api.resource.lib + response.data.img4
        that.info.img5_show = that.api.resource.lib + response.data.img5
        that.info.img6_show = that.api.resource.lib + response.data.img6
        that.info.img7_show = that.api.resource.lib + response.data.img7
        that.info.img8_show = that.api.resource.lib + response.data.img8
        that.info.img9_show = that.api.resource.lib + response.data.img9
