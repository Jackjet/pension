  ...
  <div class="toExamine-page">
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="16">
        ...
        <basic-information v-if="detailData" :type="1" :details="detailData" style="margin-top:20px" bType="1">
          <el-col :span="12" v-if="form.applyType===2">
            <el-form-item label="本人工资性收入(元)" prop="wagesIncome" label-width="150px">
              <el-input v-model="form.wagesIncome" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.applyType===2">
            <el-form-item label="本人经营性收入(元)" prop="businessIncome" label-width="150px">
              <el-input v-model="form.businessIncome" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.applyType===2">
            <el-form-item label="本人财产性收入(元)" prop="propertyIncome" label-width="150px">
              <el-input v-model="form.propertyIncome" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.applyType===2">
            <el-form-item label="本人转移性收入(元)" prop="transIncome" label-width="150px">
              <el-input v-model="form.transIncome" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.applyType===2">
            <el-form-item label="赡养费(元)" prop="alimony">
              <el-input v-model="form.alimony" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.applyType===2">
            <el-form-item label="配偶是否健在" prop="spouseLie">
              <el-radio-group v-model="form.spouseLie">
          ...
          <el-col :span="12" v-if="form.applyType===2">
            <el-form-item label="配偶月收入(元)" prop="spouseIncome">
              <el-input v-model="form.spouseIncome" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.applyType===2">
            <el-form-item label="本人月收入(元)" prop="monthlyIncome">
              <el-input v-model="form.monthlyIncome" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.applyType===2">
            <el-form-item label="同户籍其他家庭成员收入总和(元)" prop="familiesSum" label-width="230px">
              <el-input v-model="form.familiesSum" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.applyType===2">
            <el-form-item label="同户籍其他家庭成员人数(人)" prop="familiesNum" label-width="200px">
              <el-input v-model="form.familiesNum" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.applyType===2">
            <el-form-item label="家庭人均收入(元)" prop="familiesAverageIncome">
              <el-input v-model="form.familiesAverageIncome" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24" v-if="form.applyType===2">
            <el-form-item label="不同户籍子女家庭人均收入" prop="unFamiliesAverageIncome" label-width="200px">
              <TableList :table-data="tableData" :table-selection="tableSelection" :table-label="tableHeader" :table-option="tableOpction">
              </TableList>
            </el-form-item>
          </el-col>
          <el-col :span="24">
          ...
          <el-col v-if="form.businessType==='养老补贴区内迁转'" :span="24">
            <el-row>
              <el-col :span="8">
              ...
              <el-col :span="8">
                <el-form-item label="所属街道" label-width="100px">
                  <el-input v-model="form.newHomeStreetName" disabled></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="所属社区" label-width="100px">
                  <el-input v-model="form.newHomeCommunityName" disabled></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-col>
          <el-col v-if="form.businessType==='养老补贴区内迁转'" :span="24">
            <el-form-item label="现户籍地详细地址">
              <el-input v-model="form.newHomeAddress" disabled></el-input>
            </el-form-item>
          </el-col>
        </basic-information>
...
import { subsidyFind, updateFind, processCheck, subsidyProcessFindAll, processInfoFindAll } from '@/api/theElderly/list.js';
...
export default {
  ...
  mounted() {
    ...
    if (this.$route.query.updateType) {
      updateFind({ id: this.$route.query.id }).then(res => {
        if (res.data.code === 1) {
          ...
          this.tableData = this.form.unFamiliesAverageIncome ? JSON.parse(this.form.unFamiliesAverageIncome) : [];
