  ...
  <div class="information-details">
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <div class="head-portrait">
            ...
            <p class="style-color"> <span>百岁营养补贴</span></p>
    ...
    <div class="tabs-nav-content">
      ...
      <!-- <div v-show="activeIndex==='2'">
        <TableList :table-data="gradeChangeList" v-loading="isSubmitLoading" :table-selection="tableSelection" :table-label="gradeChangeListHeader" :table-option="tableOpction">
        </TableList> -->
