<template>
  <!-- 注销申请 低保、低收入、优抚对象困难老人 -->
  <div class="business-apply-page">
    <business-process :dataList="applyList"></business-process>
    <basic-information ref="obtainSonData" :applyType="1" :type="1" :details="details" @formValue="formValue" @registerAddress="registerAddress" :bType="bType">
