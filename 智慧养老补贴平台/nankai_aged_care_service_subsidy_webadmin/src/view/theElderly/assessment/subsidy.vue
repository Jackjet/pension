      ...
      <el-form ref="formSlot" :model="formSlot" :rules="rulesSlot" label-width="140px">
        <el-col :span="12">
          <el-form-item label="等级">
            <el-select v-model="formSlot.al" disabled>
...
export default {
  ...
  mounted() {
    ...
    streetList().then(res => {
      if (res.data.code === 1) {
        ...
        //     this.formSlot.streetId = item.id;
        //     this.formSlot.streetName = item.name;
        //   }
        // })
      }
    });
  ...
  methods: {
    ...
    handleSuccess(response, file, fileList, item) {
      // console.log(this.fileJson[item])
