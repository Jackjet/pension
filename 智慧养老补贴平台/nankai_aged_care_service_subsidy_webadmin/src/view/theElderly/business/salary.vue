          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item label="所属街道" prop="homeStreetId" label-width="100px">
                <el-select :disabled="true" size="medium" v-model="sqjd1" value-key="id" placeholder="所属街道" @change="homeStreetIdHandle">
            ...
            <el-col :span="8">
              <el-form-item label="所属社区" prop="homeCommunityId" label-width="100px">
                <el-select :disabled="true" size="medium" v-model="sqjd2" value-key="id" placeholder="所属社区" @change="homeCommunityIdHandle">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="辅助证件" prop="assistFile">
              <span style="color:red">请根据老人类型上传对应凭证</span>
  ...
  methods: {
    ...
    onSubmit(formFile) {
      ...
      if (this.isSubmit.childrenForm && this.isSubmit.formSlot && this.isSubmit.formFile) {
        if (ages(this.submitObject.birthday) < 80) {
          this.$message('由于您年龄未满80周岁，暂不能申请居家养老补贴');
        } else if (this.formSlot.familiesAverageIncome >= 2180) {
