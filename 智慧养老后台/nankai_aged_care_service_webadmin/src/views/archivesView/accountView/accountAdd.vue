            ...
            <el-row class='el-row-el' style="text-align: left;">
              <el-col :span="14">
                <el-form-item label="头像">
                  <!--<img class="agedMsgImg" :src="ImgUrl" />-->
                  <el-image style="width: 100px; height: 100px; margin-left: 10px" :src="ImgUrl" :preview-src-list="srcList">
                ...
                <el-form-item :label="item.label" v-show="item.isOwnFlag" :required="true">
                  ...
                  <div class="imgFlex">
                    <div v-for="(items, i) in item.iconArr" :key="i" style="float: left; margin-right:10px;">
                      <img class="agedMsgImg" v-if="items.icon" :src="items.iconAll" />
