      ...
      <!-- <el-form v-if="type === '1'" ref="typeForm" :model="typeForm" :rules="typeRules" label-width="180px">
        <el-form-item label="操作类型" style="text-align: left" prop="operationType">
          <el-select v-model="typeForm.operationType" @change="operationTypeChange" placeholder="请选择操作类型">
            ...
            <el-option label="更新老人评估等级" value="更新老人评估等级" v-if="infoForm.type == '2'"></el-option>
          </el-select>
        </el-form-item>
      </el-form> -->
      <!-- 公安数据 -->
      ...
      <el-col :span="24" class="ta-l" v-loading="loading">
        <el-form ref="infoForm" :model="infoForm" :rules="rules" label-width="190px">
            ...
            <el-row class="el-row-el">
              ...
              <el-col :span="12">
                <el-form-item label="老人分类" style="text-align: left" prop="type">
                  <el-select style="width: 100%" v-model="infoForm.type" disabled @change="typeChange" placeholder="请选择老人分类">
              ...
              <el-col :span="24">
                <el-form-item label="老人类型" prop="genreId">
                  <el-checkbox-group v-model="infoForm.genreId">
                    <el-checkbox v-for="(item, i) in genreList" :key="i" :disabled="disabled" :label="item.id" name="type">{{ item.name }}
                    </el-checkbox>
                  </el-checkbox-group>
                </el-form-item>
              </el-col>
            ...
            <el-row class="el-row-el" style="text-align: left">
              <el-col :span="14">
                <el-form-item label="头像">
                  <el-image v-if="infoForm.icon || isShowIcon" style="width: 100px; height: 100px" :src="ImgUrl" :preview-src-list="[ImgUrl]">
                  </el-image>
          ...
          <div v-if="isModel2">
            ...
            <el-row class="el-row-el">
              <el-col :span="12">
                <el-form-item label="行为能力" style="text-align: left">
                  <el-select style="width: 100%" v-model="infoForm.bodyId" :disabled="disabled" placeholder="请选择行为能力">
            ...
            <el-row class="el-row-el" style="text-align: left">
              <el-col :span="24">
                <el-form-item label="残疾类别">
                  <el-radio-group v-model="infoForm.disabilityId">
                    <el-radio v-for="(item, i) in disabilityList" :key="i" :disabled="disabled" :label="item.id" name="type">{{ item.name }}
                    </el-radio>
                  </el-radio-group>
                </el-form-item>
              </el-col>
            ...
            <el-row class="el-row-el" style="text-align: left">
              <el-col :span="12">
                <el-form-item label="残疾证号">
                  <el-input v-model="infoForm.disabilityCertificateNum" :disabled="disabled"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="持证状态" style="text-align: left">
                  <el-select style="width: 100%" v-model="infoForm.certificateStatus" :disabled="disabled" placeholder="请选择持证状态">
                    <el-option label="持证" value="持证"></el-option>
                    <el-option label="未持证" value="未持证"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row class="el-row-el" style="text-align: left">
              <el-col :span="12">
                <el-form-item label="残疾等级" style="text-align: left">
                  <el-select @change="selectChanged" style="width: 100%" v-model="infoForm.disabilityLevel" :disabled="disabled" placeholder="请选择残疾等级">
              ...
              <el-col :span="12">
                <el-form-item label="残疾等级说明">
                  <el-input v-model="infoForm.disabilityLevelRemark" :disabled="disabled"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row class="el-row-el" style="text-align: left">
              <el-col :span="8">
                <el-form-item label="现居住街道">
                  <el-input v-model="infoForm.currentStreetName" :disabled="disabled"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="现居住社区">
                  <el-input v-model="infoForm.currentCommunityName" :disabled="disabled"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="现居住详细地址">
                  <el-input v-model="infoForm.currentAddress" :disabled="disabled"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row class="el-row-el">
              <el-col :span="24">
                <el-form-item label="亲属信息" style="text-align: left">
                  <el-button type="primary" size="medium" v-if="!disabled" icon="el-icon-plus" @click="add">添加
                  </el-button>
                </el-form-item>
              </el-col>
              <el-col :span="24">
                <el-table :data="
                    table.list.data.slice(
                      (table.paging.currentPage - 1) * table.paging.limit,
                      table.paging.currentPage * table.paging.limit
                    )
                  " empty-text="暂无数据" class="el_tab_alage" style="width: 100%">
                  ...
                  <el-table-column fit align="center" :label="table.list.operation.label" v-if="table.list.operation" :width="table.list.operation.width">
                    <template slot-scope="scope">
                      <el-button v-for="(value, item) in table.list.operation.event" type="text" :icon="value.icon" :key="item" @click.native.prevent="
                          value.method !== undefined
                            ? value.method(scope.row, scope)
                            : ''
                        ">{{ value.label }}
                      </el-button>
                    </template>
                ...
                <el-form-item :label="item.label" v-show="item.isOwnFlag" :required="true">
                  ...
                  <div class="imgFlex">
                    <div v-for="(items, i) in item.iconArr" :key="i" style="float: left; margin-right: 10px">
                      <el-image v-if="items.icon" style="width: 100px; height: 100px" :src="items.iconAll" :preview-src-list="[items.iconAll]">
                      </el-image>
                  ...
                  <div style="position: relative">
                    ...
                    <span class="ps" v-if="item.remark && !disabled">{{
                      item.remark
                    }}</span>
                  </div>
                </el-form-item>
...
export default {
    ...
    return {
      ...
      uploudFormArr: [
        ...
        },
        {
          ...
          isOwnFlag: true,
          remark:
            '支持多张 （备注：包括 本人户口本首页、本人户口页、户口本其他人复印件）',
        },
        {
          id: 5,
          label: '6.本人银行流水凭证',
        ...
        },
        {
          ...
          isOwnFlag: true,
          remark:
            '选择否时，展示代办人身份证复印件及代办人分户口本复印件，选择是时，不展示。',
        },
        {
          id: 7,
          label: '代办人身份证复印件',
        ...
        },
        {
          ...
          isOwnFlag: true,
          remark:
            '支持多张（备注：请上传 其他子女户口本复印件、其他子女银行流水、减免或免除赡养费）',
        },
      ],
      infoForm: {
        // 模块一
        ...
        demand: '',
        cardCode: '',
        disabilityCertificateNum: '',
        certificateStatus: '',
        disabilityLevel: '',
        disabilityLevelRemark: '',
        currentStreetName: '',
      ...
      rules: {
        // 模块一
        idCard: [
          // { required: true, validator: "请输入身份号码", trigger: ["blur"] },
        ...
        assessMoney: [
          ...
          {
            required: true,
            validator: this.common.isvalidFloat,
            trigger: 'blur',
          },
        ],
      },
        ...
        phone: [
          {
            required: true,
            // message: "请输入联系方式",
            validator: this.common.isvalidPhone,
            trigger: ['blur'],
          },
        ],
        sex: [
  ...
  mounted() {
    ...
    if (this.type === '0' || this.type === '6') {
      ...
      this.isModel3 = true
      if (
        this.optType === '普通申请居家养老' ||
        this.optType === '居家养老材料数据更新'
      ) {
        this.isModel1 = false
        this.isModel2 = false
      }
  ...
  methods: {
      ...
      try {
        ...
        if (response.code === 1) {
          ...
          if (
            ...
            // 居家老人显示评估等级
            if (Data.type === '2' && this.type !== '3' && this.type !== '6') {
              this.isModel6 = true
            }
          }
          /**
          ...
          if (Data.disabilityId) {
            this.infoForm.disabilityId = JSON.parse(this.infoForm.disabilityId)[0]
          } else {
            ...
            this.uploudFormArr.forEach((item, index) => {
              ...
              switch (item.type) {
                case 'userHomeExtends0':
                  let userHomeArr0 = JSON.parse(
                    Data.userHome.userHomeExtends0[0].extendInfo
                  )
                ...
                case 'userHomeExtends1':
                  let userHomeArr1 = JSON.parse(
                    Data.userHome.userHomeExtends1[0].extendInfo
                  )
                ...
                case 'userHomeExtends2':
                  let userHomeArr2 = JSON.parse(
                    Data.userHome.userHomeExtends2[0].extendInfo
                  )
    ...
    async agedVerify() {
      ...
      try {
        ...
        // let url = this.api.user.findById;
        let obj = {
              ...
              try {
                that.table.list.data.forEach((item) => {
                  ...
                  if (this.openId !== item.id) {
                    if (
                      item.isGuardian === '是' &&
                      this.form.isGuardian === '1'
                    ) {
                      throw new Error('该老人已设置监护人，请勿重复设置。')
                    }
                    if (
                      item.idCard === this.form.idCard &&
                      this.openId !== item.id
                    ) {
    ...
    selectChanged() {
      ...
      this.disabilityList.forEach((item) => {
        if (this.infoForm.disabilityId === item.id) {
          disabilityName = item.name
        }
      })
      if (disabilityName !== '多重') {
        if (disabilityName !== undefined) {
          this.infoForm.disabilityLevelRemark = disabilityName + this.infoForm.disabilityLevel
        } else {
          this.infoForm.disabilityLevelRemark = this.infoForm.disabilityLevel
        }
      }
    },
    // 添加数据
      ...
      that.$refs.infoForm.validate(async (index) => {
        ...
        try {
          ...
          let obj = {
            ...
            disabilityCertificateNum: this.infoForm.disabilityCertificateNum,
            certificateStatus: this.infoForm.certificateStatus,
            disabilityLevel: this.infoForm.disabilityLevel,
            disabilityLevelRemark: this.infoForm.disabilityLevelRemark,
            currentStreetName: this.infoForm.currentStreetName,
            currentCommunityName: this.infoForm.currentCommunityName,
            currentAddress: this.infoForm.currentAddress,
            // 亲属信息
            ...
            userHome: {
              ...
              idCard:
                this.uploudFormArr[7].iconArr.length > 0
                  ? this.uploudFormArr[7].iconArr[0].icon
                  : '',
            ...
            assessMoney:
              parseFloat(this.infoForm.assessMoney) * parseFloat(100),
          }
          // console.log('44445')
          /**
           * 模块三数据处理
          ...
          if (that.id && this.optType !== '居家老人申请') {
            ...
            if (this.typeForm.operationType === '去世老人数据更新') {
              ...
              let response = await this.request.dataPut(
                that,
                url,
                this.dieForm
              )
            ...
            // 普通申请居家养老
            if (
              this.typeForm.operationType === '普通申请居家养老' ||
              this.optType === '普通申请居家养老'
            ) {
            ...
            // 居家养老材料数据更新
            if (
              this.typeForm.operationType === '居家养老材料数据更新' ||
              this.optType === '居家养老材料数据更新'
            ) {
              url = that.api.user.userHomeUpdate
            }
            // 更新老人评估等级
            if (this.typeForm.operationType === '更新老人评估等级') {
              url = this.api.user.assessRecordUpdate
            }
            obj.id = that.id
            response = await this.request.dataPut(that, url, obj)
          } else {
