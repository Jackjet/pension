              ...
              <el-col :span="24">
                <el-form-item label="残疾类别">
                  <el-checkbox-group v-model="infoForm.disabilityId">
                    <el-checkbox v-for="(item, i) in disabilityList" :key="i" :disabled="disabled" :label="item.id" name="type">{{item.name}}</el-checkbox>
                  </el-checkbox-group>
                </el-form-item>
              </el-col>
            </el-row>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        height: [
          { required: false, pattern: /^[1-9]\d*$/, message: '请输入整数', trigger: ['blur'] }
        ],
        weight: [
  ...
  mounted() {
    ...
    if (this.type === '0' || this.type === '6') {
      ...
      this.isModel2 = true
      this.isModel3 = true
      if (this.optType === '普通申请居家养老' || this.optType === '居家养老材料数据更新') {
        this.isModel1 = false
        this.isModel2 = false
      }
